						...
						{displayedListings.map(item => (
							<div className="col" key={item.id}>
								<div className="card h-100">
									{item.images?.[0] ? (
										<img src={item.images[0]} className="card-img-top" alt={item.title} style={{ height: 160, objectFit: 'cover' }} />
									) : (
											<img src={`https://placehold.co/800x500?text=${encodeURIComponent(t('marketplace.card.noImageText'))}`} className="card-img-top bg-light" alt={t('marketplace.card.noImageAlt')} style={{ height: 160, objectFit: 'cover' }} />
									)}
